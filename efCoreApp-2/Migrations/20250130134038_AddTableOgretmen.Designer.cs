...
namespace BlogApp.Migrations
{
    ...
    [Migration("20250130134038_AddTableOgretmen")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogApp.Data.Ogretmen", b =>
                {
                    b.Property<int>("OgretmenId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BlogApp.Data.Kurs", b =>
                {
                    b.HasOne("BlogApp.Data.Ogretmen", "Ogretmen")
                        .WithMany("Kurslar")
            ...
            modelBuilder.Entity("BlogApp.Data.KursKayit", b =>
                {
                    b.HasOne("BlogApp.Data.Kurs", "Kurs")
                        .WithMany("KursKayitlari")
                        .HasForeignKey("KursId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlogApp.Data.Ogrenci", "Ogrenci")
                        .WithMany("KursKayitlari")
